...
slug: openspace-self-evolving-agent
date: 2026-04-16
cover: https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1400&q=85
category: 工程拾贝
tags:
  - AI
  - Claude Code
  ...
  - 工具推荐
  - 工程化
description: 港大 HKUDS 实验室开源的 OpenSpace 通过 MCP 协议接入 Claude Code、Cursor 等工具，让 AI
  Agent 像人一样从经验中学习——成功路径自动封装为 Skill，下次同类任务直接复用，无需重复推理。
draft: false
---
