...
date: 2025-11-13
cover: https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1400&q=85
category: 工程拾贝
tags:
  - Vercel
  - 部署
  ...
  - CI/CD
  - 域名
description: 详细介绍如何使用Vercel部署前端项目，包括GitHub集成、自定义域名配置、环境变量设置等实用技巧。
draft: false
---
